...
const main = async () => {
  ...
  //stopped at line 14 https://learn.figment.io/v/master/network-documentation/polkadot/tutorials/intro-pathway-polkadot-basics/5.-staking-tokens
  ...
  const delay = 0;
  let txHash = await api.tx.proxy.addProxy(proxyAccount.address, proxyType, delay).signAndSend(account);
